									...
									<div class="card-body">
										<div class="row">
											<div class="col-lg-12 col-sm-12">
												<p>Powered by Font Awesome set. For more info <a href="https://fontawesome.com/v4.7.0/" target="_blank">click here</a>.</p>
											...
											<div class="col-lg-12 col-sm-12">
												<div class="icons-list-wrap">
													<ul class="icons-list">
														...
														<li class="icons-list-item"><i class="fa fa-area-chart" data-toggle="tooltip" title="fa fa-area-chart"></i></li>
														<li class="icons-list-item"><i class="fa fa-area-chart-o" data-toggle="tooltip" title="fa fa-area-chart-o"></i></li>
