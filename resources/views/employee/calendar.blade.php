        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group-addon wrap-input100 validate-input">
                        <!--date-->
                        <input class="text-center input100 border-white bg-light" type="text" id="addDate" name="addDate" readonly>
                        <span class="focus-input100"></span>
                    ...
                    <div class="form-group-addon wrap-input100 validate-input">
                    <!--time-->
                        <input class="text-center input100 border-white bg-light" type="number" step="0.5" id="addTime" name="addTime" min="1" max="12" placeholder="12 hours max">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100"><i class="mdi mdi-timer" aria-hidden="true">Hours Worked :
                                </i></span>
                    </div>
                    ...
                    <div class="form-group-addon wrap-input100 validate-input">
                     <!--comment-->
                            <textarea class="input100 border-white bg-light" type="text" name="addComment" id="addComment"
                                      rows="4" cols="50"></textarea>
                        <span class="focus-input100"></span>
                        <span class="symbol-input100"><i class="mdi mdi-comment" aria-hidden="true"></i></span>
                    </div>
