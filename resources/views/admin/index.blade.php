        ...
        <div class="col-sm-12 col-md-3">
            <div class="card bg-purple-gradient img-card box-secondary-shadow">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="text-white">
                            <h2 class="mb-0 number-font">{{$holidaysPerTotal}}</h2>
                            <p class="text-white mb-0">Holidays Taken!</p>
                        </div>
                        <div class="ml-auto"><i class="fa fa-address-book-o text-white fs-30 mr-2 mt-2"></i></div>
                    </div>
                </div>
        ...
        <div class="col-md-12 col-lg-6">
            <div class="card">
                <div class="card-body text-center">
                    <h4 class=""><span class="text-orange"><i class="fe fe-file-text mr-2 fs-20 text-orange-shadow"></i></span>Total
                        Projects</h4>
            ...
            <div class="card overflow-hidden">
                <div class="card-body text-center">
                    <h4 class=""><span class="text-orange"><i
                                    class="fe fe-users mr-2 fs-20 text-orange-shadow"></i></span>Total Employees</h4>
